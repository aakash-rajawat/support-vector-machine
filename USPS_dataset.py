...
eight = {}
# Load digit data
one.update({'train': np.loadtxt('data\\digit_1_train.dat', delimiter=',')})
one.update({'test': np.loadtxt('data\\digit_1_test.dat', delimiter=',')})
three.update({'train': np.loadtxt('data\\digit_3_train.dat', delimiter=',')})
three.update({'test': np.loadtxt('data\\digit_3_test.dat', delimiter=',')})
eight.update({'train': np.loadtxt('data\\digit_8_train.dat', delimiter=',')})
eight.update({'test': np.loadtxt('data\\digit_8_test.dat', delimiter=',')})
